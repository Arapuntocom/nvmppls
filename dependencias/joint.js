...
var g = (function() {
    ...
    g.Ellipse.fromRect = function(rect) {
        ...
        return Ellipse(rect, rect.width / 2, rect.height / 2);
    };
...
// Enlace NOVA
joint.dia.Enlace = joint.dia.Link.extend({
...
joint.shapes.basic.CicloConversacional = joint.shapes.basic.Generic.extend({

    markup: '<g class="rotatable"><g class="scalable"><ellipse/><path class="este"/><path class="norte"/><path class="oeste"/><path class="sur"/></g><text class="nombre"/><text class="cliente"/><text class="realizador"/><text class="observador"/><text class="idNova"/></g>',

    defaults: joint.util.deepSupplement({

        type: 'basic.CicloConversacional',
        ...
        attrs: {
            ...
            'path.este':{ stroke: '#000000', d: 'M-67 0 h 15 '},
            'path.norte':{  stroke: '#000000', d: 'M0 -37 v 15 '},
            'path.oeste':{ stroke: '#000000', d: 'M53 0 h 15 '},
            'path.sur':{ stroke: '#000000', d: 'M0 23 v 15 '},
            '.nombre': {
                'font-size': 14,
                text: '',
                'text-anchor': 'middle',
...
joint.shapes.basic.And = joint.shapes.basic.Generic.extend({
...
joint.shapes.basic.Or = joint.shapes.basic.Generic.extend({

    markup: '<g><g class="rotatable"><g class="scalable"><rect/></g></g><text class="idNova"/><text class="condiciones"/></g>',
